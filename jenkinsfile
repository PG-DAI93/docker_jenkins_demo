    ...
    stages {
        ...
        stage('Push to DockerHub') {
            steps {
                ...
                script {
                    try {
                        withCredentials([usernamePassword(credentialsId: 'my-docker-hub-credentials-id', usernameVariable: 'pgdai93', 
                        passwordVariable: 'dckr_pat_J80qLRKTlcqd-k8tNd5UKdUZbwU')]) {
