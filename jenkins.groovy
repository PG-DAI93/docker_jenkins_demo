pipeline {
    ...
    environment {
        ...
        GIT_REPOSITORY_URL = 'https://github.com/PG-DAI93/docker_jenkins_demo.git'
        DOCKER_IMAGE_NAME = 'pgdai93/docker_jenkins_demo'
    ...
    stages {
        ...
        stage('Push to DockerHub') {
            steps {
                ...
                script {
                    try {
                        withCredentials([usernamePassword(credentialsId: 'my-docker-hub-credentials-id', usernameVariable: 'pgdai93', passwordVariable: 'dckr_pat_J80qLRKTlcqd-k8tNd5UKdUZbwU')]) {
